...
This is your project! It's a com.sample, deployable Maven 3 project to help you
...
a persistence unit and some com.sample persistence and transaction code to help
...
This will deploy `target/jboss7example.war`.
 
The application will be running at the following URL <http://localhost:8080/jboss7example/>.
...
By default, tests are configured to be skipped. The reason is that the com.sample
